        ...
        return(
            <UserContext.Consumer>
              {user => (
                ...
                {this.state.userMeals < 1 ? <p>Welcome to your personalized Food Tracker, click on the 'Log new meal' button to add your most recent meal or snack.  Be sure to add in all food items you ate.  You can always go back and edit your meal.  The graph will update and any foods that may make you sick will be highlighted below</p> : null}
